  ...
  return (
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        <motion.h1 variants={variants}>Let's celebrate</motion.h1>
        <motion.div className="item" variants={variants}>
          <h2>E-Mail</h2>
          <a href="mailto:khan.jd082@gmail.com">
            <span>khan.jd082@gmail.com</span>
          </a>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <a href="tel:+919136846849">
            <span>+919136846849</span>
          </a>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          ...
          <br />
          <h3>Click below to contact now 👇</h3>
        </motion.div>
      </motion.div>
      <a
        href="https://wa.me/919136846849" // Ensure no '+' sign in the URL
        target="_blank"
      ...
      >
        <div className="text">
          ...
          >
            <svg height="400px" width="300px" viewBox="0 0 512 512">
              <motion.path
